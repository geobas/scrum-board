...
var Board = exports.Board = function (_React$Component) {
    ...
    _createClass(Board, [{
        ...
        value: function eachNote(note, i) {
            return _react2.default.createElement(_Note_browserified2.default, { key: note.id,
                index: i,
        ...
        value: function render() {
            ...
            //             })}
            //        </div>;
            return _react2.default.createElement('div', { className: 'board' }, this.state.notes.map(this.eachNote), _react2.default.createElement('button', { className: 'btn btn-sm btn-success glyphicon glyphicon-plus', onClick: this.add.bind("null", "New Note") }));
        }
    }]);
...
_react2.default.render(_react2.default.createElement(Board, { count: 10 }), document.getElementById('react-container'));

},{"./Note_browserified.js":158,"react":156}],158:[function(require,module,exports){
"use strict";
