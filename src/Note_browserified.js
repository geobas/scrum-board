...
exports.default = exports.Note = undefined;
...
var Note = exports.Note = function (_React$Component) {
    ...
    _createClass(Note, [{
        ...
        value: function componentDidMount() {
            $(_react2.default.findDOMNode(this)).draggable();
        }
    }, {
        key: 'randomBetween',
        ...
        value: function renderDisplay() {
            return _react2.default.createElement('div', { className: 'note', style: this.style }, _react2.default.createElement('p', null, this.props.children), _react2.default.createElement('span', null, _react2.default.createElement('button', { onClick: this.edit, className: 'btn btn-primary glyphicon glyphicon-pencil' }), _react2.default.createElement('button', { onClick: this.remove, className: 'btn btn-danger glyphicon glyphicon-trash' })));
        }
    }, {
        key: 'renderForm',
        value: function renderForm() {
            return _react2.default.createElement('div', { className: 'note', style: this.style }, _react2.default.createElement('textarea', { ref: 'newText', defaultValue: this.props.children, className: 'form-control' }), _react2.default.createElement('button', { onClick: this.save, className: 'btn btn-success btn-sm glyphicon glyphicon-floppy-disk' }));
        }
    }, {
        key: 'render',
