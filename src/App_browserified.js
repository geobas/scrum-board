...
var _Board_browserified = require('./Board_browserified.js');

var _Board_browserified2 = _interopRequireDefault(_Board_browserified);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_react2.default.render(_react2.default.createElement(_Board_browserified2.default, { count: 10 }), document.getElementById('react-container'));

},{"./Board_browserified.js":158,"react":156}],158:[function(require,module,exports){
"use strict";
...
(function e(t, n, r) {
    function s(o, u) {
        ...
        var _Note_browserified = require("./Note_browserified.js");

        var _Note_browserified2 = _interopRequireDefault(_Note_browserified);
        ...
        var Board = exports.Board = function (_React$Component) {
            ...
            _createClass(Board, [{
                ...
                value: function eachNote(note, i) {
                    return React.createElement(_Note_browserified2.default, { key: note.id,
                        index: i,
                ...
                value: function render() {
                    ...
                    //             })}
                    //        </div>;
                    return React.createElement("div", { className: "board" }, this.state.notes.map(this.eachNote), React.createElement("button", { className: "btn btn-sm btn-success glyphicon glyphicon-plus", onClick: this.add.bind("null", "New Note") }));
                }
            }]);
    ...
    }, { "./Note_browserified.js": 2 }], 2: [function (require, module, exports) {
        "use strict";
                ...
                var Note = exports.Note = function (_React$Component) {
                    ...
                    _createClass(Note, [{
                        ...
                        value: function renderDisplay() {
                            return React.createElement('div', { className: 'note', style: this.style }, React.createElement('p', null, this.props.children), React.createElement('span', null, React.createElement('button', { onClick: this.edit, className: 'btn btn-primary glyphicon glyphicon-pencil' }), React.createElement('button', { onClick: this.remove, className: 'btn btn-danger glyphicon glyphicon-trash' })));
                        }
                    }, {
                        key: 'renderForm',
                        value: function renderForm() {
                            return React.createElement('div', { className: 'note', style: this.style }, React.createElement('textarea', { ref: 'newText', defaultValue: this.props.children, className: 'form-control' }), React.createElement('button', { onClick: this.save, className: 'btn btn-success btn-sm glyphicon glyphicon-floppy-disk' }));
                        }
                    }, {
                        key: 'render',
                        value: function render() {
...
},{"./Note_browserified.js":159}],159:[function(require,module,exports){
"use strict";
